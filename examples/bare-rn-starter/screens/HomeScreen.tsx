...
const categories = [
  { title: "Forms", description: "Input, Checkbox, Switch, Select, Slider, and more", screen: "Forms", count: 17 },
  { title: "Data Display", description: "Text, Badge, Card, Avatar, Table, Calendar, and more", screen: "DataDisplay", count: 14 },
  { title: "Feedback", description: "Alert, Dialog, Toast, Banner, Tooltip, and more", screen: "Feedback", count: 8 },
  { title: "Navigation", description: "Tabs, Accordion, Collapsible, Drawer", screen: "Navigation", count: 4 },
