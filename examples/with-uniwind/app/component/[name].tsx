...
const demos: Record<string, () => React.ReactElement> = {
  ...
  combobox: () => {
    ...
    return (
      <View className="gap-6">
        <Text className="text-sm text-zinc-500 dark:text-zinc-400">A searchable select with multi-select, groups, clear button, custom rendering, and more. Type to filter, then select from matching results.</Text>
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Basic</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Multiple Selection</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
            <Label>Tags</Label>
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Groups</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Clear Button</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Custom Items</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
            <Label>Choose with custom rendering</Label>
            <Combobox placeholder="Select..." options={frameworks} value={val} onValueChange={setVal} renderItem={(option, selected) => (<View className="flex-row items-center px-5 py-3 gap-3"><View className={selected ? "h-4 w-4 rounded-full bg-zinc-900 dark:bg-white" : "h-4 w-4 rounded-full border border-zinc-300 dark:border-zinc-700"} /><Text className="text-zinc-900 dark:text-zinc-100">{option.label}</Text></View>)} />
          </View>
        </View>
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Invalid</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
            <Label>Required field</Label>
            <Combobox placeholder="Select framework..." options={frameworks} value={invalidVal} onValueChange={setInvalidVal} invalid />
            <Text className="text-sm text-red-500">Please select a framework</Text>
          </View>
        </View>
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Disabled</Text>
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Auto Highlight</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
        ...
        <View className="gap-2">
          <Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Popup Mode</Text>
          <View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-3">
  ...
  tabs: () => {
    return (
      <View className="gap-6">
        <Text className="text-sm text-zinc-500 dark:text-zinc-400">Tab navigation with filled/line variants, sizes, vertical, icons, disabled, and RTL.</Text>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Default (Filled)</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4"><Tabs defaultValue="account"><TabsList><TabsTrigger value="account">Account</TabsTrigger><TabsTrigger value="password">Password</TabsTrigger></TabsList><TabsContent value="account"><Text variant="muted" className="py-3">Account settings.</Text></TabsContent><TabsContent value="password"><Text variant="muted" className="py-3">Password settings.</Text></TabsContent></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Line Variant</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4"><Tabs defaultValue="overview" variant="line"><TabsList><TabsTrigger value="overview">Overview</TabsTrigger><TabsTrigger value="analytics">Analytics</TabsTrigger><TabsTrigger value="reports">Reports</TabsTrigger></TabsList><TabsContent value="overview"><Text variant="muted" className="py-3">Overview.</Text></TabsContent><TabsContent value="analytics"><Text variant="muted" className="py-3">Analytics.</Text></TabsContent><TabsContent value="reports"><Text variant="muted" className="py-3">Reports.</Text></TabsContent></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Vertical</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4"><Tabs defaultValue="general" orientation="vertical" variant="line"><TabsList><TabsTrigger value="general">General</TabsTrigger><TabsTrigger value="security">Security</TabsTrigger><TabsTrigger value="notifs">Notifs</TabsTrigger></TabsList><TabsContent value="general"><Text variant="muted">General.</Text></TabsContent><TabsContent value="security"><Text variant="muted">Security.</Text></TabsContent><TabsContent value="notifs"><Text variant="muted">Notifications.</Text></TabsContent></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Disabled</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4"><Tabs defaultValue="active"><TabsList><TabsTrigger value="active">Active</TabsTrigger><TabsTrigger value="disabled" disabled>Disabled</TabsTrigger><TabsTrigger value="other">Other</TabsTrigger></TabsList><TabsContent value="active"><Text variant="muted" className="py-3">Active.</Text></TabsContent><TabsContent value="other"><Text variant="muted" className="py-3">Other.</Text></TabsContent></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Icons</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4"><Tabs defaultValue="profile"><TabsList><TabsTrigger value="profile" icon={<Text className="text-xs">👤</Text>}>Profile</TabsTrigger><TabsTrigger value="settings" icon={<Text className="text-xs">⚙️</Text>}>Settings</TabsTrigger></TabsList><TabsContent value="profile"><Text variant="muted" className="py-3">Profile.</Text></TabsContent><TabsContent value="settings"><Text variant="muted" className="py-3">Settings.</Text></TabsContent></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Sizes</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 gap-4"><Tabs defaultValue="a" size="sm"><TabsList><TabsTrigger value="a">Small</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList></Tabs><Tabs defaultValue="a" size="md"><TabsList><TabsTrigger value="a">Medium</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList></Tabs><Tabs defaultValue="a" size="lg"><TabsList><TabsTrigger value="a">Large</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList></Tabs></View></View>
        <View className="gap-2"><Text className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">RTL</Text><View className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4" style={{ direction: "rtl" }}><Tabs defaultValue="home" variant="line"><TabsList><TabsTrigger value="home">الرئيسية</TabsTrigger><TabsTrigger value="settings">الإعدادات</TabsTrigger></TabsList><TabsContent value="home"><Text variant="muted" className="py-3">الرئيسية</Text></TabsContent><TabsContent value="settings"><Text variant="muted" className="py-3">الإعدادات</Text></TabsContent></Tabs></View></View>
      </View>
    );
  },
  collapsible: () => {
