...
export function ComponentScreen({ name, onBack }: ComponentScreenProps) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <View className="flex-row items-center px-4 py-3 border-b border-border">
        <Pressable onPress={onBack} className="mr-3 h-10 w-10 items-center justify-center rounded-full" accessibilityRole="button" accessibilityLabel="Go back">
      ...
      <ScrollView className="flex-1 px-5" contentContainerStyle={{ paddingVertical: 24 }}>
        ...
        {Demo ? <Demo /> : (
          <View className="items-center py-12">
            <Text className="text-muted-foreground">Demo coming soon</Text>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
