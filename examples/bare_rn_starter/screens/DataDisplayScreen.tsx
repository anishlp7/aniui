...
import { View, ScrollView, Alert, Pressable, Text as RNText } from "react-native";
...
export interface DataDisplayScreenProps {
  onBack: () => void;
}

export function DataDisplayScreen({ onBack }: DataDisplayScreenProps) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView className="flex-1 px-4" contentContainerClassName="gap-6 py-6">
        ...
        <Text variant="muted">25 components for presenting content and data.</Text>
