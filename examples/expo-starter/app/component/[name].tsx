...
const demos: Record<string, () => React.ReactElement> = {
  ...
  "data-table": () => {
    ...
    return (
      <View className="gap-6">
        <Text className="text-sm text-muted-foreground">A sortable, filterable data table with pagination. Tap column headers to sort, use the search bar to filter.</Text>
        <View className="gap-2">
