...
const demos: Record<string, () => React.ReactElement> = {
        ...
        <View className="gap-2">
          ...
          <View className="rounded-lg border border-border bg-card p-4 gap-3">
            ...
            <Combobox
              ...
              onSelectedValuesChange={setMultiVal}
            />
        ...
        <View className="gap-2">
          ...
          <View className="rounded-lg border border-border bg-card p-4 gap-3">
            ...
            <Combobox
              ...
              options={[]}
              groups={[
                { label: "Frameworks", options: [{ label: "React Native", value: "rn" }, { label: "Flutter", value: "flutter" }, { label: "Swift UI", value: "swiftui" }] },
                { label: "Languages", options: [{ label: "TypeScript", value: "ts" }, { label: "Dart", value: "dart" }, { label: "Swift", value: "swift" }] },
              ]}
              value={groupVal}
            ...
            <Combobox
              ...
              renderItem={(option, selected) => (
                <View className="flex-row items-center px-5 py-3 gap-3">
                  <View className={selected ? "h-4 w-4 rounded-full bg-primary" : "h-4 w-4 rounded-full border border-input"} />
  ...
  tabs: () => {
    return (
      <View className="gap-6">
        <Text className="text-sm text-muted-foreground">Tab navigation with filled and line variants, sizes, vertical layout, icons, disabled state, and RTL support.</Text>
        {/* Default (Filled) */}
        <View className="gap-2">
          <Text className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Default (Filled)</Text>
          <View className="rounded-lg border border-border bg-card p-4">
            <Tabs defaultValue="account">
              ...
              <TabsContent value="account"><Text variant="muted" className="py-3">Manage your account settings.</Text></TabsContent>
              <TabsContent value="password"><Text variant="muted" className="py-3">Change your password.</Text></TabsContent>
            </Tabs>
          </View>
        </View>
        {/* Line Variant */}
        <View className="gap-2">
          <Text className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Line Variant</Text>
          <View className="rounded-lg border border-border bg-card p-4">
            <Tabs defaultValue="overview" variant="line">
              ...
              <TabsContent value="overview"><Text variant="muted" className="py-3">Project overview and summary.</Text></TabsContent>
              <TabsContent value="analytics"><Text variant="muted" className="py-3">Detailed analytics data.</Text></TabsContent>
              <TabsContent value="reports"><Text variant="muted" className="py-3">Generate reports.</Text></TabsContent>
            </Tabs>
          </View>
        </View>
        {/* Vertical */}
        <View className="gap-2">
          <Text className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Vertical</Text>
          <View className="rounded-lg border border-border bg-card p-4">
            <Tabs defaultValue="general" orientation="vertical" variant="line">
              ...
              <TabsContent value="general"><Text variant="muted">General settings.</Text></TabsContent>
              <TabsContent value="security"><Text variant="muted">Security settings.</Text></TabsContent>
              <TabsContent value="notifs"><Text variant="muted">Notification preferences.</Text></TabsContent>
            </Tabs>
          </View>
        </View>
        {/* Disabled */}
        <View className="gap-2">
          ...
          <View className="rounded-lg border border-border bg-card p-4">
            <Tabs defaultValue="active">
              ...
              <TabsContent value="active"><Text variant="muted" className="py-3">This tab is active.</Text></TabsContent>
              <TabsContent value="other"><Text variant="muted" className="py-3">Another tab.</Text></TabsContent>
            </Tabs>
          </View>
        </View>
        {/* Icons */}
        <View className="gap-2">
          <Text className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Icons</Text>
          <View className="rounded-lg border border-border bg-card p-4">
            <Tabs defaultValue="profile">
              <TabsList>
                <TabsTrigger value="profile" icon={<Text className="text-xs">👤</Text>}>Profile</TabsTrigger>
                <TabsTrigger value="settings" icon={<Text className="text-xs">⚙️</Text>}>Settings</TabsTrigger>
              </TabsList>
              <TabsContent value="profile"><Text variant="muted" className="py-3">Edit your profile.</Text></TabsContent>
              <TabsContent value="settings"><Text variant="muted" className="py-3">App settings.</Text></TabsContent>
            </Tabs>
          </View>
        </View>
        {/* Sizes */}
        <View className="gap-2">
          ...
          <View className="rounded-lg border border-border bg-card p-4 gap-4">
            <Tabs defaultValue="a" size="sm">
              <TabsList><TabsTrigger value="a">Small</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList>
            </Tabs>
            <Tabs defaultValue="a" size="md">
              <TabsList><TabsTrigger value="a">Medium</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList>
            </Tabs>
            <Tabs defaultValue="a" size="lg">
              <TabsList><TabsTrigger value="a">Large</TabsTrigger><TabsTrigger value="b">Tabs</TabsTrigger></TabsList>
            </Tabs>
          </View>
        </View>
        {/* RTL */}
        <View className="gap-2">
          <Text className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">RTL</Text>
          <View className="rounded-lg border border-border bg-card p-4" style={{ direction: "rtl" }}>
            <Tabs defaultValue="home" variant="line">
              ...
              <TabsContent value="home"><Text variant="muted" className="py-3">محتوى الصفحة الرئيسية</Text></TabsContent>
              <TabsContent value="settings"><Text variant="muted" className="py-3">إعدادات التطبيق</Text></TabsContent>
              <TabsContent value="profile"><Text variant="muted" className="py-3">معلومات الملف الشخصي</Text></TabsContent>
            </Tabs>
          </View>
        </View>
      </View>
