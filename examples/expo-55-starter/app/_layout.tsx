...
const lightColors: ThemeColors = { bg: "#ffffff", fg: "#09090b", muted: "#f4f4f5", mutedFg: "#71717a", border: "#e4e4e7", primary: "#18181b", primaryFg: "#fafafa", card: "#ffffff", accent: "#f4f4f5", secondary: "#f4f4f5" };
const darkColors: ThemeColors = { bg: "#09090b", fg: "#fafafa", muted: "#27272a", mutedFg: "#a1a1aa", border: "#27272a", primary: "#fafafa", primaryFg: "#09090b", card: "#09090b", accent: "#27272a", secondary: "#27272a" };
