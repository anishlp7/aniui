...
Built with [Uniwind](https://uniwind.dev) (recommended) or [NativeWind](https://www.nativewind.dev), [rn-primitives](https://rn-primitives.vercel.app) for accessibility, [lucide-react-native](https://lucide.dev) icons, [class-variance-authority](https://cva.style), and strict TypeScript. **149 components** + 15 pre-built screen blocks.
...
**149 components** in `cli/src/registry.ts` (tiers 1–4; the source of truth for installs and the registry):
