...
export const registry: Record<string, ComponentEntry> = {
  ...
  "time-picker": {
    ...
    description: "Animated scroll-snap wheel time picker with a spring modal and haptic tick, plus DateAndTimePicker (calendar + time)",
    dependencies: ["react-native-reanimated", "expo-haptics", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: ["calendar", "theme-provider", "animate"],
    tier: 2,
  },
  slider: {
    name: "Slider",
  ...
  "vertical-flow-carousel": {
    name: "VerticalFlowCarousel",
    file: "components/ui/vertical-flow-carousel.tsx",
    description: "Vertical coverflow — cards scale, tilt, and fade as they scroll away from center, with a blur overlay on unfocused cards",
    dependencies: ["react-native-reanimated", "expo-blur", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
  ...
  "vertical-page-carousel": {
    name: "VerticalPageCarousel",
    file: "components/ui/vertical-page-carousel.tsx",
    description: "Full-bleed vertical pager — one card fills the screen at a time, neighbors scale/fade out, with a haptic tick on release",
    dependencies: ["react-native-reanimated", "expo-haptics", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
