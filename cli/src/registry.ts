export type ComponentEntry = {
  ...
  tier: 1 | 2 | 3 | 4;
  /** Docs sidebar group, e.g. "Carousels", "Loaders", "UI Pieces" */
  group?: string;
  /** Docs sidebar section, e.g. "Motion & Effects" */
  category?: string;
};
...
export const registry: Record<string, ComponentEntry> = {
  ...
  "pie-chart": {
    ...
    description: "Skia pie/donut chart with grow-in sweep, data morphing, and drag-to-select slice push-out",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "react-native-gesture-handler", "clsx", "tailwind-merge"],
    registryDependencies: ["chart-tooltip"],
    tier: 3,
  },
  ...
  gradient: {
    name: "Gradient",
    file: "components/ui/gradient.tsx",
  ...
  "keyboard-view": {
    name: "KeyboardView",
    file: "components/ui/keyboard-view.tsx",
  ...
  shimmer: {
    ...
    description: "Content-aware skeleton with sweep/pulse variants, 4 directions, named color presets, and isLoading reveal",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: ["animate"],
    tier: 2,
    category: "Motion & Effects",
  ...
  "carousel-3d": {
    name: "Carousel3D",
    file: "components/ui/carousel-3d.tsx",
    description: "3D cylindrical carousel with real perspective-projected faces, pan gestures, and snap physics",
    dependencies: ["react-native-gesture-handler", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
  ...
  "carousel-parallax": {
    ...
    file: "components/ui/carousel-parallax.tsx",
    description: "Horizontal carousel with real inner-layer parallax translation and a haptic tick on release",
  ...
  "flip-card": {
    ...
    description: "Tap-to-flip card with horizontal/vertical/depth 3D rotation, mid-flip glass blur, and haptic feedback",
    dependencies: ["react-native-reanimated", "expo-blur", "expo-haptics", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
  ...
  marquee: {
    ...
    description: "Infinite horizontal ticker for any content — reverse direction, tap-to-pause, and hold-to-speed-up",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: ["animate", "text"],
    tier: 2,
    category: "Motion & Effects",
    group: "Micro-interactions",
  },
  "disclosure-group": {
    ...
    file: "components/ui/disclosure-group.tsx",
    description: "Animated grouped disclosure sections with measured-height reveal, spring press feedback, and an optional frosted-blur reveal",
  ...
  "event-ticket": {
    name: "EventTicket",
    file: "components/ui/event-ticket.tsx",
    description: "Event ticket card with perforated edge, date, venue, and seat",
    dependencies: ["lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  "receipt-card": {
    name: "ReceiptCard",
    file: "components/ui/receipt-card.tsx",
    description: "Tilted, torn-edge receipt card with dotted item leaders and a printed barcode",
    dependencies: ["react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  coupon: {
    name: "Coupon",
    file: "components/ui/coupon.tsx",
    description: "Two-section promotional coupon with a real tear-line, ticket icon, and orientation prop",
    dependencies: ["lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  polaroid: {
    name: "Polaroid",
    file: "components/ui/polaroid.tsx",
    description: "Polaroid-style photo frame with a press-lift-and-straighten spring and optional washi-tape decoration",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "UI Pieces",
  ...
  "profile-card": {
    ...
    description: "Profile card with a cover image, overlapping avatar, location row, and a press-scale action button",
  ...
  "carousel-circular": {
    name: "CarouselCircular",
    file: "components/ui/carousel-circular.tsx",
    description: "Scroll-driven coverflow carousel with per-item lift, tilt, and a blur fade on non-centered items",
    dependencies: ["react-native-reanimated", "expo-blur", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
    group: "Carousels",
  ...
  "carousel-scale": {
    name: "CarouselScale",
    file: "components/ui/carousel-scale.tsx",
    description: "Center-focused carousel where neighbors zoom up and rotate out, with a haptic tick on release",
    dependencies: ["react-native-reanimated", "expo-haptics", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "carousel-tilt": {
    name: "CarouselTilt",
    file: "components/ui/carousel-tilt.tsx",
    description: "Z-axis fan carousel — slides rotate and lift from a bottom pivot, with an optional blur overlay",
    dependencies: ["react-native-reanimated", "expo-blur", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "curved-bottom-tabs": {
    name: "CurvedBottomTabs",
    file: "components/ui/curved-bottom-tabs.tsx",
    description: "Bottom tab bar whose curved notch and floating gradient button slide to track the active tab, with badge support and keyboard auto-hide",
    dependencies: ["react-native-svg", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
  ...
  "morphing-tabbar": {
    name: "MorphingTabBar",
    file: "components/ui/morphing-tabbar.tsx",
    description: "Segmented tab bar where each tab's own corner radii and spacing morph to split the active tab into a separated pill",
    dependencies: ["react-native-reanimated", "expo-haptics", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "mobile-dock": {
    name: "MobileDock",
    file: "components/ui/mobile-dock.tsx",
    description: "Finger-tracked fisheye dock — drag across icons to magnify the one under your touch, release to tap the nearest one",
    dependencies: ["react-native-reanimated", "react-native-gesture-handler", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
  ...
  "photo-stack": {
    name: "PhotoStack",
    file: "components/ui/photo-stack.tsx",
    description: "Overlapping stacked photos with a press-lift-and-straighten spring, and optional per-photo onPress",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "UI Pieces",
  ...
  "book-page": {
    name: "BookPage",
    file: "components/ui/book-page.tsx",
    description: "Book cover with spine gradient, page-edge texture, and an openAngle-driven hinge",
    dependencies: ["react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  "barcode-badge": {
    name: "BarcodeBadge",
    file: "components/ui/barcode-badge.tsx",
    description: "Width-encoded barcode strip with compound Root/Bars/Label API and palette overrides",
    dependencies: ["clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  "social-button": {
    name: "SocialButton",
    file: "components/ui/social-button.tsx",
    description: "Branded social sign-in button with default Google/Apple/GitHub/X marks, outline/filled/ghost variants, and a press-scale spring",
    dependencies: ["class-variance-authority", "react-native-svg", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "UI Pieces",
    group: "Identity & Social",
  ...
  "verified-badge": {
    ...
    description: "Verified check badge with Name/Handle layout and palette overrides",
    dependencies: ["lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 1,
    category: "UI Pieces",
  ...
  "qr-code": {
    ...
    description: "Real, scannable QR code behind an expand/collapse reveal with copy/close actions",
    dependencies: ["react-native-qrcode-svg", "react-native-svg", "react-native-reanimated", "lucide-react-native", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "UI Pieces",
    group: "Identity & Social",
  ...
  "rolling-counter": {
    name: "RollingCounter",
    file: "components/ui/rolling-counter.tsx",
    description: "Animated odometer-style rolling number counter with motion-blur, squash/stretch, staggered digits, and correct wrap-around rollover",
    dependencies: ["react-native-reanimated", "expo-blur", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "UI Pieces",
  ...
  "border-beam": {
    ...
    description: "Sweeping multi-hue beam arc with ambient glow, traced around a rounded border",
  ...
  "gooey-switch": {
    name: "GooeySwitch",
    file: "components/ui/gooey-switch.tsx",
    description: "Skia metaball goo switch — blurred anchor blobs and bridge fuse via an alpha-threshold ColorMatrix, with tap or velocity-aware drag toggle",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "react-native-gesture-handler", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
  ...
  "morph-loader": {
    name: "MorphLoader",
    file: "components/ui/morph-loader.tsx",
    description: "Skia-drawn loader that morphs through 6 Material-style silhouettes with independent continuous rotation",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "class-variance-authority", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
    group: "Skia Effects",
  ...
  "verified-shine": {
    name: "VerifiedShine",
    file: "components/ui/verified-shine.tsx",
    description: "Verified badge with a shine sweep masked to the icon's own silhouette",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
    group: "Skia Effects",
  ...
  "radiant-button": {
    name: "RadiantButton",
    file: "components/ui/radiant-button.tsx",
    description: "CTA button with a traveling border glow, diagonal shimmer, and pulsing radial ambient glow",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "class-variance-authority", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
  ...
  "morph-fab": {
    name: "MorphFab",
    file: "components/ui/morph-fab.tsx",
    description: "Skia gooey radial/directional FAB menu with staggered blob-merge spring animation",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
  ...
  "gooey-search-tabs": {
    name: "GooeySearchTabs",
    file: "components/ui/gooey-search-tabs.tsx",
    description: "Skia gooey pill that morphs between a search bar and a tab switcher",
    dependencies: ["@shopify/react-native-skia", "react-native-reanimated", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 4,
    category: "Motion & Effects",
  ...
  tray: {
    name: "Tray",
    file: "components/ui/tray.tsx",
    description: "Compound bottom-sheet/navigation-tray system with multi-view push/back navigation, draggable detents, and scroll hand-off",
    dependencies: ["react-native-reanimated", "react-native-gesture-handler", "react-native-safe-area-context", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  ...
  "unfold-menu": {
    name: "UnfoldMenu",
    file: "components/ui/unfold-menu.tsx",
    description: "Menu whose trigger unfolds into a full panel, its label morphing into the panel's title as it expands",
    dependencies: ["react-native-reanimated", "react-native-safe-area-context", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Navigation & Overlays",
    group: "Compound Overlays",
  ...
  "action-rail": {
    name: "ActionRail",
    file: "components/ui/action-rail.tsx",
    description: "Expandable icon toolbar that reveals labeled actions, with its own light/dark palette system",
    dependencies: ["react-native-reanimated", "lucide-react-native", "react-native-svg", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Navigation & Overlays",
  ...
  "split-view": {
    ...
    description: "Draggable, resizable top/bottom split pane with snap points and spring physics",
    dependencies: ["react-native-reanimated", "react-native-gesture-handler", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Navigation & Overlays",
  ...
  "matched-geometry": {
    ...
    file: "components/ui/matched-geometry.tsx",
    description: "SwiftUI-style shared-element layout transition primitive — morphs one tagged view into another's position and size when they swap",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "flexi-button": {
    name: "FlexiButton",
    file: "components/ui/flexi-button.tsx",
    description: "Adaptive-width pill button that springs open to reveal a label, with a dimension-change callback",
    dependencies: ["lucide-react-native", "react-native-svg", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "spin-button": {
    name: "SpinButton",
    file: "components/ui/spin-button.tsx",
    description: "Toggle button with a custom SVG arc spinner and crossfading label on press",
    dependencies: ["react-native-svg", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "stacked-chips": {
    name: "StackedChips",
    file: "components/ui/stacked-chips.tsx",
    description: "Nested, depth-aware expandable chip menu — a trigger reveals further stacked chips",
    dependencies: ["react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 2,
    category: "Motion & Effects",
  ...
  "filling-stack": {
    name: "FillingStack",
    file: "components/ui/filling-stack.tsx",
    description: "Vertically browsable card stack with fling gestures and a blur \"filling\" transition between cards",
    dependencies: ["react-native-reanimated", "react-native-gesture-handler", "expo-blur", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
    group: "Micro-interactions",
  ...
  "animated-header-scrollview": {
    name: "AnimatedHeaderScrollView",
    file: "components/ui/animated-header-scrollview.tsx",
    description: "iOS-style collapsing large-title header ScrollView with blur backdrop on scroll",
    dependencies: ["react-native-reanimated", "expo-blur", "react-native-safe-area-context", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
    category: "Motion & Effects",
    group: "Navigation Chrome",
