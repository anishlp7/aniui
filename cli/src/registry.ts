...
export const registry: Record<string, ComponentEntry> = {
  ...
  tabs: {
    ...
    dependencies: ["@rn-primitives/tabs", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  collapsible: {
    ...
    dependencies: ["@rn-primitives/collapsible", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  toast: {
    ...
    dependencies: ["@rn-primitives/toast", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  dialog: {
    ...
    dependencies: ["@rn-primitives/dialog", "@rn-primitives/portal", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  "alert-dialog": {
    ...
    dependencies: ["@rn-primitives/alert-dialog", "@rn-primitives/portal", "react-native-reanimated", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  tooltip: {
  ...
  slider: {
    ...
    dependencies: ["@rn-primitives/slider", "class-variance-authority", "clsx", "tailwind-merge"],
    registryDependencies: [],
    tier: 3,
  },
  toggle: {
  ...
  combobox: {
    ...
    description: "Searchable select dropdown with type-to-filter",
    dependencies: ["clsx", "tailwind-merge"],
    registryDependencies: ["search-bar"],
    tier: 1,
  },
  "progress-steps": {
    name: "ProgressSteps",
