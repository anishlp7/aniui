      ...
      {open && (
        <div className="absolute inset-0 z-10 flex items-center justify-center rounded-lg">
          ...
          <div className="relative z-20 w-[260px] rounded-xl bg-card p-5 shadow-xl">
            <div className="pb-3">
              <h3 className="text-base font-semibold text-card-foreground">Delete &quot;Q3 Roadmap&quot;?</h3>
              <p className="text-sm text-muted-foreground mt-1">This project and all of its data will be permanently deleted. This can&apos;t be undone.</p>
            </div>
