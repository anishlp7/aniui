...
export const metadata: Metadata = {
  ...
  description: "shadcn/ui for React Native. 90 accessible components built with NativeWind, rn-primitives, and TypeScript. Copy. Paste. Ship.",
  ...
  openGraph: {
    ...
    description: "shadcn/ui for React Native. 90 accessible components. Copy. Paste. Ship.",
  },
  twitter: {
