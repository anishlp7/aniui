    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
          <li>Uses <code className="rounded bg-secondary px-1.5 py-0.5 text-xs font-mono">@rn-primitives/tabs</code> for keyboard arrow navigation and focus management.</li>
