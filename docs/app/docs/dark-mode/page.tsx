...
export default function DarkModePage() {
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6 text-foreground leading-7">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Expo Setup</Heading>

        <Heading as="h3" className="text-lg font-semibold pt-2">1. Configure app.json</Heading>
        <p className="text-muted-foreground">
  ...
  "expo": {
    "userInterfaceStyle": "automatic"
        ...
        <Heading as="h3" className="text-lg font-semibold pt-2">2. Import global CSS</Heading>
        <p className="text-muted-foreground">
...
export default function RootLayout() {
  // ...
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Manual Toggle</Heading>
        <p className="text-muted-foreground">
  ...
  return (
    ...
    >
      <Text className="text-secondary-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Uniwind</Heading>
        <p className="text-muted-foreground">
        ...
        <Heading as="h3" className="text-lg font-semibold pt-2">1. global.css setup</Heading>
        <p className="text-muted-foreground">
  ...
  :root {
    ...
    @variant dark {
      ...
      /* ... dark values */
        ...
        <Heading as="h3" className="text-lg font-semibold pt-2">2. Toggle theme</Heading>
        <CodeBlock
          title="components/theme-toggle.tsx"
          code={`import { Pressable, Text } from "react-native";
  ...
  return (
    ...
    >
      <Text className="text-secondary-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Bare React Native</Heading>
        <p className="text-muted-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Using Dark Mode in Components</Heading>
        <p className="text-muted-foreground">
