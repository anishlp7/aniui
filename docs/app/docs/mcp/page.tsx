      ...
      <div className="space-y-6 text-foreground leading-7">
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>&bull; <strong className="text-foreground">93 component source files</strong> — real code, not summaries</li>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-muted-foreground">
              <tr className="border-b border-border">
                ...
                <td className="py-2">List all 93 components with names, descriptions, and tiers</td>
              </tr>
              <tr className="border-b border-border">
