  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6 text-foreground leading-7">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Bottom Sheet / Action Sheet / Select</Heading>
        <p className="text-muted-foreground">
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      {/* Your app content */}
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Keyboard Handling</Heading>
        <p className="text-muted-foreground">
  ...
  "expo": {
    "android": {
      "softInputMode": "adjustResize"
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Dialog / Alert Dialog</Heading>
        <p className="text-muted-foreground">
...
useEffect(() => {
  ...
  return () => handler.remove();
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Switch</Heading>
        <p className="text-muted-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Shadows &amp; Elevation</Heading>
        <p className="text-muted-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Safe Area</Heading>
        <p className="text-muted-foreground">
        ...
        <Heading as="h2" className="text-2xl font-semibold tracking-tight pt-4">Testing Checklist</Heading>
        <p className="text-muted-foreground">
