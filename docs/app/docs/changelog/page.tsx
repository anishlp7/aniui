...
const releases: Release[] = [
  {
    version: "0.5.0",
    date: "2026-07-15",
    title: "Lucide icons, AI components + 100 components",
    changes: [
      { type: "feat", text: "Four flagship components land: prompt-input (ChatGPT/Claude-style AI composer with attach/voice/send-stop), streaming-text (typewriter AI response with blinking cursor), swipe-deck (Tinder-style card stack), and slide-to-confirm (slide-to-pay control) — 100 components total.", link: "/docs/prompt-input" },
      ...
      { type: "feat", text: "Three new components: avatar-group (overlapping stack with +N overflow), gradient (SVG linear gradient view), and keyboard-view (keyboard-avoiding form wrapper) — these brought the count to 96 before the AI components above took it to 100.", link: "/docs/avatar-group" },
