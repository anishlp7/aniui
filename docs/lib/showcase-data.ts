...
export const showcaseCatalog: ShowcaseEntry[] = [
  ...
  { slug: "carousel-circular", displayName: "Circular Carousel", tagline: "Coverflow — the centered card lifts and sharpens, neighbors fall back and blur.", group: "carousels", hasWebPreview: true },
  ...
  { slug: "vertical-flow-carousel", displayName: "Vertical Flow Carousel", tagline: "Scroll vertically through a tilting, blurring stream of cards.", group: "carousels", hasWebPreview: true },
  { slug: "vertical-page-carousel", displayName: "Vertical Page Carousel", tagline: "One full-bleed card per screen, paged vertically.", group: "carousels", hasWebPreview: true },
