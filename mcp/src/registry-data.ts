...
export const registry: Record<string, ComponentEntry> = {
  ...
  calendar: { name: "Calendar", file: "components/ui/calendar.tsx", description: "Month calendar with single and range selection", dependencies: ["clsx", "tailwind-merge"], registryDependencies: [], tier: 1 },
  "date-picker": { name: "DatePicker", file: "components/ui/date-picker.tsx", description: "Date picker with calendar popup and range support", dependencies: ["clsx", "tailwind-merge"], registryDependencies: ["calendar"], tier: 1 },
  slider: { name: "Slider", file: "components/ui/slider.tsx", description: "Draggable slider for numeric values", dependencies: ["react-native-gesture-handler", "react-native-reanimated", "class-variance-authority", "clsx", "tailwind-merge"], registryDependencies: [], tier: 2 },
